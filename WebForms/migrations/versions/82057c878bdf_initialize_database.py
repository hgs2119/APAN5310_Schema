...
Revision ID: 82057c878bdf
Revises: 7ddd4bc22fc6
Create Date: 2022-12-08 14:53:10.724886
...
revision = '82057c878bdf'
down_revision = '7ddd4bc22fc6'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('lead', sa.String(length=150), nullable=False),
    ...
    sa.ForeignKeyConstraint(['group_id', 'petitioner_name'], ['petitioners.group_id', 'petitioners.firm_name'], ),
    sa.ForeignKeyConstraint(['law_firm_name', 'law_lead'], ['law_firms.firm_name', 'law_firms.lead'], ),
    sa.PrimaryKeyConstraint('group_id', 'petitioner_name', 'law_firm_name', 'law_lead')
    )
